...
$(document).ready(function() {
    $('#relatorio_consultor').click(function(){
        consultores = retornaConsultor();
        $.get( "con_desem_consultor_rela", { consultor: consultores, mesini: $('#mesini').val(), mesfim: $('#mesfim').val(), anoini : $('#anoini').val(), anofim: $('#anofim').val() })
          .done(function( data ) {
            $('#conteudo').html(data)
              console.log(data)
        });
    ...
    $('#grafico_consultor').click(function(){
        consultores = retornaConsultor();
        $.get( "con_desem_consultor_grafico", { consultor: consultores, mesini: $('#mesini').val(), mesfim: $('#mesfim').val(), anoini : $('#anoini').val(), anofim: $('#anofim').val() })
          .done(function( data ) {
            $('#conteudo').html(data)
        });
    });

  $('#pizza_consultor').click(function(){
        consultores = retornaConsultor();
        $.get( "con_desem_consultor_pizza", { consultor: consultores, mesini: $('#mesini').val(), mesfim: $('#mesfim').val(), anoini : $('#anoini').val(), anofim: $('#anofim').val() })
          .done(function( data ) {
            $('#conteudo').html(data)
        });
    });

  $('#relatorio_consultor_cliente').click(function(){
        consultores = retornaConsultor();
        $.get( "con_desem_consultor_rela_cliente", { consultor: consultores, mesini: $('#mesini').val(), mesfim: $('#mesfim').val(), anoini : $('#anoini').val(), anofim: $('#anofim').val() })
          .done(function( data ) {
            $('#conteudo').html(data)
              console.log(data)
        });
    ...
    $('#grafico_consultor_cliente').click(function(){
        consultores = retornaConsultor();
        $.get( "con_desem_consultor_grafico_cliente", { consultor: consultores, mesini: $('#mesini').val(), mesfim: $('#mesfim').val(), anoini : $('#anoini').val(), anofim: $('#anofim').val() })
          .done(function( data ) {
            $('#conteudo').html(data)
        });
    });

  $('#pizza_consultor_cliente').click(function(){
        consultores = retornaConsultor();
        $.get( "con_desem_consultor_pizza_cliente", { consultor: consultores, mesini: $('#mesini').val(), mesfim: $('#mesfim').val(), anoini : $('#anoini').val(), anofim: $('#anofim').val() })
          .done(function( data ) {
            $('#conteudo').html(data)
        });
    });
...
function retornaConsultor(){
  ...
  $('#list2 option').each(function(i, sel){ 
      consultores[i] = $(sel).val();
  });
  if(consultores.length == 0){
      alert('Informe os consultores.');
      return false;  
  }
  return consultores;
}