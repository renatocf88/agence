...
<BODY>
  ...
  <div class="pricing-header pb-md-4 mx-auto text-center"">
     <a href="con_desempenho"><button type="button" class="btn btn-outline-light text-dark active">Por Consultor</button></a>
    <a href="con_desempenho_cliente"><button type="button" class="btn btn-outline-light text-dark">Por Cliente</button></a>
    </div>
  <div class="container">
      <div class="card-deck mb-3 text-center">
        ...
        <div class="card mb-4 box-shadow">
          <div class="card-header">
            Consultores para pesquisa<br><br>
          </div>
          <div class="card-body">
          ...
          <div class="card-body" style="padding-left: 25%;">
            <div class="col-md-12">
              <div class="input-group">
                ...
                <button type="button"  class="input-group-text pointer" id='relatorio_consultor'>Listagem</button>
              </div>
          </div>
          <br>
          <div class="col-md-12">
            <div class="input-group">
                ...
                <button type="button"  class="input-group-text pointer" id='grafico_consultor'>Gr&aacute;fico</button>
              </div>
          </div>
          <br>
          <div class="col-md-12">
            <div class="input-group">
                ...
                <button type="button"  class="input-group-text pointer" id='pizza_consultor'>Pizza</button> 
              </div>             
          </div>
          </div>
        </div>
